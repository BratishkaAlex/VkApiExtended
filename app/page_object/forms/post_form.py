...
class PostForm:
    ...
    def is_post_displayed(self, post_id, owner_id, message):
    ...
    def is_doc_attached_to_post(self, post_id, file_name):
    ...
    def get_post(self, post_id, owner_id, message):
    ...
    def get_file_link(self, post_id, file_name):
